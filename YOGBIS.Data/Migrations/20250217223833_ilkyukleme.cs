        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KomisyonUyeDurum = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UlkeTecihId = table.Column<byte[]>(nullable: false),
                    KayitTarihi = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UlkeTercih", x => x.UlkeTecihId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MulakatlarMulakatId = table.Column<byte[]>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Adaylar_Komisyonlar_KomisyonlarKomisyonId",
                        column: x => x.KomisyonlarKomisyonId,
                        principalTable: "Komisyonlar",
                        principalColumn: "KomisyonId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Adaylar_Mulakatlar_MulakatlarMulakatId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BransCinsiyet = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Branslar_UlkeTercih_UlkeTercihId",
                        column: x => x.UlkeTercihId,
                        principalTable: "UlkeTercih",
                        principalColumn: "UlkeTecihId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YabanciDilBelge = table.Column<string>(nullable: true),
                    ...
                    YabanciDilIGN = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdayBasvuruBilgileri_Adaylar_AdaylarAdayId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotKategoriId = table.Column<byte[]>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdayNot", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TYSKomisyonSiraNo = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DosyaGaleri_Adaylar_AdaylarAdayId",
                        column: x => x.AdaylarAdayId,
                        principalTable: "Adaylar",
                        principalColumn: "AdayId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Subeler_Okullar_OkullarOkulId",
                        column: x => x.OkullarOkulId,
                        principalTable: "Okullar",
                        principalColumn: "OkulId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FotoGaleri_Subeler_SubelerSubeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdayBasvuruBilgileri_AdaylarAdayId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Adaylar_KomisyonlarKomisyonId",
                table: "Adaylar",
                column: "KomisyonlarKomisyonId");

            migrationBuilder.CreateIndex(
                name: "IX_Adaylar_MulakatlarMulakatId",
                table: "Adaylar",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Branslar_UlkeTercihId",
                table: "Branslar",
                column: "UlkeTercihId");

            migrationBuilder.CreateIndex(
                name: "IX_DosyaGaleri_AdaylarAdayId",
                table: "DosyaGaleri",
                column: "AdaylarAdayId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FotoGaleri_SubelerSubeId",
                table: "FotoGaleri",
