...
namespace YOGBIS.Data.Migrations
{
    public partial class yenileme : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AktiviteId = table.Column<int>(nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    KayitTarihi = table.Column<DateTime>(nullable: false),
                    AktiviteAdi = table.Column<string>(nullable: true),
                    OkulId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Aktivitelers", x => x.AktiviteId);
                    table.ForeignKey(
                        name: "FK_Aktivitelers_AspNetUsers_KaydedenId",
                        column: x => x.KaydedenId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Aktivitelers_Okullars_OkulId",
                        column: x => x.OkulId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Aktivitelers_KaydedenId",
                table: "Aktivitelers",
                column: "KaydedenId");

            migrationBuilder.CreateIndex(
                name: "IX_Aktivitelers_OkulId",
                table: "Aktivitelers",
                column: "OkulId");
